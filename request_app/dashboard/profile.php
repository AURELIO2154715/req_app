...
<html>
    ...
    <body>
        <?php 
            ...
            $req_accounting = "SELECT request_id, received_by, request_status, use_of_item, date_needed,request_form.created_at FROM request_form INNER JOIN status_report ON request_form_id = requested_by WHERE received_by = '6' and request_status = 'approved'"; 
